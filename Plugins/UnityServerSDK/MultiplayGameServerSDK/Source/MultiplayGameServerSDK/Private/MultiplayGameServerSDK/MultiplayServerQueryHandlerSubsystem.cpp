...
void UMultiplayServerQueryHandlerSubsystem::IncrementCurrentPlayers() 
{
	...
	{
		UE_LOG(LogMultiplayGameServerSDK, Warning, TEXT("Cannot increment CurrentPlayers above the maximum number of players, %u."), GetMaxPlayers());
	}
}
...
{ 
	...
	{
		UE_LOG(LogMultiplayGameServerSDK, Warning, TEXT("Attempted to assign a value greater than the maximum number of allowed players, %u, it will be ignored."), GetMaxPlayers());
		return;
	}
